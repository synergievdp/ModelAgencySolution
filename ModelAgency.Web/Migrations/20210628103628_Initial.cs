        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelUser_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModelUser_StreetAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModelUser_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModelUser_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invite", x => new { x.ModelId, x.EventId });
                    table.ForeignKey(
                        name: "FK_Invite_AspNetUsers_ModelId",
                        column: x => x.ModelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
